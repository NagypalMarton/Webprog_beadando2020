...
<form action = "?oldal=belep" method = "post">
 ...
 <br>
 <input type="text" name="user_name" placeholder="felhasználó" required><br><br>
 <input type="password" name="user_passworld" placeholder="jelszó" required><br><br>
 ...
 <input type="text" name="vezeteknev" placeholder="utónév" required><br><br>
